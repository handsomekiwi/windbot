...
namespace WindBot.Game.AI.Decks
{
    ...
    public class BrandishLordExecutor : DefaultExecutor
    {
            ...
            : base(ai, duel)            
        {
            ...
            AddExecutor(ExecutorType.SpSummon, CardId.BrandishMaidenKagari, KagariSummon);
            ...
            AddExecutor(ExecutorType.SpSummon, CardId.BrandishMaidenShizuku, ShizukuSummon);
            AddExecutor(ExecutorType.Activate, CardId.BrandishMaidenShizuku, ShizukuEffect);
            AddExecutor(ExecutorType.SpSummon, CardId.BrandishMaidenHayate, HayateSummon);
